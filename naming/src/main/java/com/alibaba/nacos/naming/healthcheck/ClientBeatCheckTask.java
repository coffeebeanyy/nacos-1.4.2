    ...
    public void run() {
        try {
            ...
            for (Instance instance : instances) {
                if (System.currentTimeMillis() - instance.getLastBeat() > instance.getInstanceHeartBeatTimeOut()) {//15s
            ...
            for (Instance instance : instances) {
                ...
                if (System.currentTimeMillis() - instance.getLastBeat() > instance.getIpDeleteTimeout()) {//30s
                    // delete instance
